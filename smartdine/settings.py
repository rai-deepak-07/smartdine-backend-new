...
MIDDLEWARE = [
    ...
    #Added for CORS by @rai_deepak_07
    'corsheaders.middleware.CorsMiddleware',
]

ROOT_URLCONF = 'smartdine.urls'

#Added for channels by @rai_deepak_07
ASGI_APPLICATION = 'smartdine.asgi.application'
...
# JWT Settings by @rai_deepak_07
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7),
}

# Channels Configuration by @rai_deepak_07
CHANNEL_LAYERS = {
    'default': {
