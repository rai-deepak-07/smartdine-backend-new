    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'Super Admin'), ('restaurant_owner', 'Restaurant Owner'), ('staff', 'Restaurant Staff'), ('customer', 'Customer')], default='customer', max_length=20)),
